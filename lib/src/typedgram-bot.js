...
var TelegramTypedBot = (function (_super) {
    ...
    function TelegramTypedBot(token, server) {
        ...
        this.on(exports.TelegramEvent.audio, function (msg) { return _this.onMessage(exports.TelegramEvent.audio, msg); });
        this.on(exports.TelegramEvent.document, function (msg) { return _this.onMessage(exports.TelegramEvent.document, msg); });
        this.on(exports.TelegramEvent.photo, function (msg) { return _this.onMessage(exports.TelegramEvent.photo, msg); });
        this.on(exports.TelegramEvent.sticker, function (msg) { return _this.onMessage(exports.TelegramEvent.sticker, msg); });
        this.on(exports.TelegramEvent.video, function (msg) { return _this.onMessage(exports.TelegramEvent.video, msg); });
        this.on(exports.TelegramEvent.contact, function (msg) { return _this.onMessage(exports.TelegramEvent.contact, msg); });
        this.on(exports.TelegramEvent.location, function (msg) { return _this.onMessage(exports.TelegramEvent.location, msg); });
        this.on(exports.TelegramEvent.group_chat_created, function (msg) { return _this.onMessage(exports.TelegramEvent.group_chat_created, msg); });
        this.on(exports.TelegramEvent.new_chat_participant, function (msg) { return _this.onMessage(exports.TelegramEvent.new_chat_participant, msg); });
        this.on(exports.TelegramEvent.left_chat_participant, function (msg) { return _this.onMessage(exports.TelegramEvent.left_chat_participant, msg); });
        this.on(exports.TelegramEvent.new_chat_title, function (msg) { return _this.onMessage(exports.TelegramEvent.new_chat_title, msg); });
        this.on(exports.TelegramEvent.new_chat_photo, function (msg) { return _this.onMessage(exports.TelegramEvent.new_chat_photo, msg); });
        this.on(exports.TelegramEvent.delete_chat_photo, function (msg) { return _this.onMessage(exports.TelegramEvent.delete_chat_photo, msg); });
    }
    ...
    TelegramTypedBot.prototype.setPlainText = function (action) {
        this.plainTextAction = action;
        console.log('Registered plain text action.');
    };
    Object.defineProperty(TelegramTypedBot.prototype, "plainText", {
        get: function () {
            var _this = this;
            return function (target, propertyKey, descriptor) {
                _this.setPlainText(descriptor.value);
                return descriptor;
            };
        },
        enumerable: true,
    ...
    TelegramTypedBot.prototype.setInitialization = function (action) {
    ...
    Object.defineProperty(TelegramTypedBot.prototype, "initialization", {
        get: function () {
            var _this = this;
            return function (target, propertyKey, descriptor) {
                _this.setInitialization(descriptor.value);
                return descriptor;
            };
        },
        enumerable: true,
